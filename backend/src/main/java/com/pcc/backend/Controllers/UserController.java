...
public class UserController {
    ...
    public ResponseEntity<?> getAllUserJPA() {
        try {
    ...
    @PostMapping("/create-user-jpa")
    public ResponseEntity<?> createUserJpa(@RequestBody UserRequestDTO userRequestDTO) {
        try {
            UserResponseDTO response = userService.createUserJpa(userRequestDTO);
            return ResponseEntity.status(HttpStatus.CREATED).body(Map.of(
                    "responseStatus", 200,
                    "responseMessage", "User created successfully",
                    "data", response
    ...
    @DeleteMapping("/delete-user-jpa/{id}")
    public ResponseEntity<?> deleteUserJpa(@PathVariable Long id) {
        try {
    ...
    @PutMapping("/update-user-jpa/{id}")
    public ResponseEntity<?> updateUserJpa(@PathVariable Long id, @RequestBody UserRequestDTO userRequestDTO) {
        try {
            UserResponseDTO response = userService.updateUserJpa(id, userRequestDTO);
            return ResponseEntity.status(HttpStatus.CREATED).body(Map.of(
                    "responseStatus", 200,
    ...
    @PostMapping("/search-by-field-jpa")
    public ResponseEntity<?> searchUsers(@RequestBody UserEntity userEntity) {
        List<UserEntity> users = userService.findUserByFieldJpa(
                userEntity.getId(),
